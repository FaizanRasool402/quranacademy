  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      <div className="max-w-6xl mx-auto">
        <div className="bg-gradient-to-br from-[#5a8a6f] to-[#4a7a5f] rounded-3xl overflow-hidden shadow-2xl relative">
          {/* Background Image */}
              ...
              <div className="relative w-full max-w-md aspect-[4/3] rounded-2xl overflow-hidden shadow-xl bg-gray-900">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-white py-3 px-4">
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
                    <p className="text-xs md:text-sm font-bold text-gray-800 text-center sm:text-left">
                      HIGHLY QUALIFIED <span className="text-green-600">MALE</span> AND{" "}
                      <span className="text-pink-600">FEMALE</span> TEACHERS
                    </p>
                    <div className="flex items-center gap-2">
                      {/* WhatsApp */}
                      <a
                        href="https://wa.me/923336650021"
                        target="_blank"
                      ...
                      <div className="flex gap-1">
                        <a
                          href="#"
                          className="w-6 h-6 bg-blue-600 rounded flex items-center justify-center hover:bg-blue-700 transition-colors"
                        >
                        ...
                        <a
                          href="#"
                          className="w-6 h-6 bg-pink-600 rounded flex items-center justify-center hover:bg-pink-700 transition-colors"
                        >
                          <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      {/* Website */}
                      <a
                        href="https://www.alsaifquranacademy.com"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs font-bold text-gray-800 hover:text-green-600 transition-colors hidden sm:block"
                      >
                        WWW.ALSAIFQURANACADEMY.COM
                      </a>
                    </div>
                  </div>
                </div>
