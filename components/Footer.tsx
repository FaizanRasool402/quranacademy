...
export default function Footer() {
  return (
    <footer className="w-full bg-[#182b68] text-white pt-12 md:pt-16 pb-6 px-4">
      <div className="max-w-6xl mx-auto">
        {/* Upper Section - 4 columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 pb-10">
          {/* Column 1 - Branding */}
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-start gap-3 mb-4">
              <Image
                src="/images/logo.jpeg"
                alt="Aiza Quran Academy"
                width={56}
                height={56}
                className="rounded-full object-cover w-14 h-14 shrink-0 border-2 border-white/30"
              />
              <div className="flex flex-col leading-tight pt-1">
                <span className="font-bold text-lg text-white">Aiza Quran</span>
                <span className="text-white/95 text-sm">Academy</span>
              </div>
            </Link>
            <p className="text-white/90 text-sm leading-relaxed">
              Our Quran Academy experience has taught us that online courses
              simply require a different type of approach to online Quran
              learning education.
            </p>
          </div>
          ...
          <div>
            <h3 className="font-bold text-[#fda600] text-base mb-4">
              Quick Links
            </h3>
        ...
        {/* Yellow divider line */}
        <div className="h-px w-full bg-[#fda600] mb-6" />

        {/* Lower Section - Copyright & Social */}
