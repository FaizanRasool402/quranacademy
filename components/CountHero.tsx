...
export default function CountHero() {
  return (
    <section className="relative min-h-[50vh] sm:min-h-[60vh] md:min-h-[70vh] w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white max-w-4xl mx-auto">
          Your Trusted Global Academy
        </h1>
        <div
          className="w-16 h-0.5 mx-auto mt-4 sm:mt-6 rounded-full"
          style={{ background: "linear-gradient(90deg, transparent, #fda600, transparent)" }}
        />
      </div>
    </section>
  );
